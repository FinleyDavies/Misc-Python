...
def main():
    ...
    FPS = 60
    DISPLAY_SURFACE = pygame.display.set_mode((WIDTH, HEIGHT),  vsync=1)
...
def move_towers(top_towers, bottom_towers):
    for i in range(len(top_towers)):
        ...
        if top_towers[i].right < 0:
            ...
            bottom_towers[i] = pygame.Rect(x, top_towers[i].height + TOWER_GAP, TOWER_WIDTH,
                                           HEIGHT - top_towers[i].height - TOWER_GAP)
